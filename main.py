...
# Data forming
   ...
   # X_train, y_train, X_control, y_control = generate_data(function, features_number, data_length, train_length_coef)
   # y_train = [-0.5, 0.2, 0.1, -0.5]
   # X_train = [np.array([0.67781654, 0.27000797, 0.73519402, 0.96218855, 0.24875314,
